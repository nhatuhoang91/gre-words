...
public abstract class RecycleViewCursorAdapter <VH extends RecyclerView.ViewHolder> extends RecyclerView.Adapter<VH>{

    private Context mContext;
    private Cursor mCursor;
    private boolean dataValid;
    private int mRowIdColumn;
    public RecycleViewCursorAdapter(Context context,Cursor cursor){
